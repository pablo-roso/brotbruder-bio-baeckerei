/* ============================================================
   brotbruder — Seitenlogik
   Mobilmenü und Öffnungsstatus. Für Samstag und Sonntag gibt es
   keine belastbare Quelle, deshalb kennt HOURS diese Tage nicht
   und der Status sagt dann schlicht, wann es sicher wieder losgeht.
   ============================================================ */
(function () {
  'use strict';
  ...
  var HOURS = { 1: [7.5, 18], 2: [7.5, 18], 3: [7.5, 18], 4: [7.5, 18], 5: [7.5, 18] };
  ...
  if (headerStatus) {
    ...
    headerStatus.textContent = open ? 'geöffnet bis ' + fmt(today[1]) : 'gerade geschlossen';
